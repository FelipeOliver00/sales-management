...
public class CategoriaServico {
    ...
    public Categoria atualizar(Long codigo, Categoria categoria) {
        Categoria cateogiraSalvar = validarCategoriaExiste(codigo);
        validarCategoriaDuplicada(categoria);
        BeanUtils.copyProperties(categoria, cateogiraSalvar, "codigo");
        return categoriaRepositorio.save(cateogiraSalvar);
    }
